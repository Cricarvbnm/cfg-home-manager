{
  ...
  outputs = { self, flake-utils, unflake, nixpkgs, home-manager, ... }@inputs:
    let
      # =====================================================================
      ...
      pkgs = import nixpkgs {
        ...
        overlays =
          [ (_: _: mapAttrs (_: value: value.${system}) (self.packages)) ];
      };
    ...
    in {
      ...
      packages = let
        inherit (builtins)
          filter match readDir attrNames listToAttrs replaceStrings;
